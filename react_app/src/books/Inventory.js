...
class Inventory extends Component {
    ...
    async _checkoutBook() {
        await this.props.checkoutBook(this.state.checkoutBook.id, this.state.name, this.state.email)
            ...
            <Paper className={classes.root}>
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={this._checkoutBook} disabled={!(!!this.state.name && !!this.state.email && !this.isInvalidEmail())} variant="contained" color="primary">
                            Yes, Checkout
                        </Button>
                    </DialogActions>
                </Dialog>
